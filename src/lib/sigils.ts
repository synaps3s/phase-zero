...
export const SIGILS: Record<string, string> = {
  ...
  /* Black Panther */
  /* M'Baku: the fist on the chest, the gorilla's gesture. */
  mbaku: `<rect x="19" y="13" width="15" height="5.2" rx="2.6" fill="currentColor"/><rect x="19" y="19.2" width="15" height="5.2" rx="2.6" fill="currentColor"/><rect x="19" y="25.4" width="15" height="5.2" rx="2.6" fill="currentColor"/><rect x="19" y="31.6" width="14" height="5" rx="2.5" fill="currentColor"/><path d="M34 16 C38 16, 39 20, 38 24 C37.5 27, 36 29, 34 29.5" fill="none" stroke="currentColor" stroke-width="3.6" stroke-linecap="round"/><path d="M13 16 A12 12 0 0 0 13 34" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M8 11 A19 19 0 0 0 8 39" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity="0.55"/>`,
